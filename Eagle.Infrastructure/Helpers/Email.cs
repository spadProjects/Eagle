...
namespace Eagle.Infrastructure.Helpers
{
    public class Email
    {
        ...
        public static async Task SendEmail(EmailFormModel emailForm)
        {
            ...
            message.From = new MailAddress("EagleWayTeam@gmail.com");  // replace with valid value
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                {
                    UserName = "EagleWayTeam@gmail.com", // replace with valid value
