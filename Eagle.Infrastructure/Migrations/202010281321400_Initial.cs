        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Message = c.String(maxLength: 800),
                        AddedDate = c.DateTime(),
                        ParentId = c.Int(),
                ...
                c => new
                    {
                        ...
                        Phone = c.String(maxLength: 600),
                        Email = c.String(maxLength: 600),
                        Message = c.String(),
                ...
                c => new
                    {
                        ...
                        Title = c.String(maxLength: 700),
                        Description = c.String(),
                        ServcieId = c.Int(nullable: false),
                        Service_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Identifier = c.String(maxLength: 600),
                        Title = c.String(maxLength: 600),
